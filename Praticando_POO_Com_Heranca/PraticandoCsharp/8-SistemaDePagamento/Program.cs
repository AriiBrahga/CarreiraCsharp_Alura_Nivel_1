...
O sistema precisa garantir que todo tipo de pagamento execute um método chamado ProcessarPagamento(), 
mas cada um com uma lógica diferente. Além disso, as pessoas envolvidas na transação têm dados em comum.

Seu desafio é combinar herança (para modelar as pessoas) e interfaces (para padronizar os métodos de pagamento).

Crie um programa que:

1 - Defina uma classe base Pessoa com os atributos Nome e Email.
2 - Crie uma interface IPagamento com o método ProcessarPagamento().
3 - Crie duas classes:
...
4 - Em cada classe de pagamento, personalize o método ProcessarPagamento() com uma mensagem diferente.
5 - Instancie um cliente para cada tipo de pagamento e chame o método ProcessarPagamento().
 */
